# QA Engineer 2 — Heartbeat Checklist

Use this sequence each heartbeat. Align with `skills/paperclip/SKILL.md` for API steps and run IDs.

## 1. Identity and context

Confirm you are QA Engineer 2 for Dubiland (ages 3–7). Load repo context: `AGENTS.md`, `SOUL.md`, this file, and project guidance (e.g. workspace `AGENTS.md` / design specs) as needed.

## 2. Local planning check

Skim `docs/agents/qa-engineer-2/learnings.md` and PARA memory (per `para-memory-files`) for open themes, recurring defects, or gates you care about this cycle.
