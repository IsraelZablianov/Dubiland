...
| Letters (אותיות) | Spec ready: Letter Tracing Trail + scaffolded Letter Sky Catcher | Spec ready: Letter Tracing Trail + Letter Sound Match + Letter Sky Catcher + Confusable Letter Contrast | Expanded coverage: Letter Sound Match + Letter Sky Catcher + Confusable Letter Contrast; bridge lanes in execution (`Sofit Word-End Detective`, `Shva Sound Switch`) |
